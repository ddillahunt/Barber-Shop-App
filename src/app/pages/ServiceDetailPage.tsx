...
export function ServiceDetailPage() {
  ...
  useEffect(() => {
    document.title = service ? `${service.title} | Grandes Ligas Barber Shop` : "Service Not Found | Grandes Ligas Barber Shop";
  }, [service]);
    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-slate-100 via-slate-200 to-slate-100 flex items-center justify-center">
        ...
        <div className="text-center">
          ...
          <Button onClick={() => navigate("/")} className="bg-gradient-to-r from-red-700 to-red-600 hover:from-red-800 hover:to-red-700 text-white font-bold">
            Return to Home
          </Button>
        </div>
        <ScrollToTop />
              ...
              <Card className="border-2 border-blue-500/30 shadow-xl bg-gradient-to-br from-slate-900 to-black sticky top-6">
                <CardContent className="p-8 space-y-6">
                  <div className="text-center pb-6 border-b border-blue-500/30">
                    <p className="text-sky-300 text-lg mb-2 font-semibold">Service Price</p>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-3 text-sky-200">
                      ...
                      <div>
                        <p className="font-semibold text-sky-300">Duration</p>
