...
const services = [
  ...
  { name: "Beard Trim & Lineup", price: "$40" },
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <Label htmlFor="name" style={{ color: "#7CB9E8", fontSize: "1rem", fontWeight: 600 }}>Full Name *</Label>
                  <Input
                    id="name"
                    value={formData.name}
                ...
                <div className="space-y-2">
                  <Label htmlFor="email" style={{ color: "#7CB9E8", fontSize: "1rem", fontWeight: 600 }}>Email</Label>
                  <Input
                    id="email"
                    type="email"
                ...
                <div className="space-y-2">
                  <Label htmlFor="phone" style={{ color: "#7CB9E8", fontSize: "1rem", fontWeight: 600 }}>Phone Number *</Label>
                  <Input
                    id="phone"
                    type="tel"
                ...
                <div className="space-y-2">
                  <Label htmlFor="barber" style={{ color: "#7CB9E8", fontSize: "1rem", fontWeight: 600 }}>Choose Your Barber</Label>
                ...
                <div className="space-y-2">
                  <Label htmlFor="service" style={{ color: "#7CB9E8", fontSize: "1rem", fontWeight: 600 }}>Service</Label>
                ...
                <div className="space-y-2">
                  <Label htmlFor="date" style={{ color: "#7CB9E8", fontSize: "1rem", fontWeight: 600 }}>Preferred Date *</Label>
                  <Input
                    id="date"
                    type="date"
                    value={formData.date}
                ...
                <div className="space-y-2">
                  <Label htmlFor="time" style={{ color: "#7CB9E8", fontSize: "1rem", fontWeight: 600 }}>Preferred Time *</Label>
                ...
                <div className="space-y-2">
                  <Label htmlFor="notes" style={{ color: "#7CB9E8", fontSize: "1rem", fontWeight: 600 }}>Notes</Label>
                  <Textarea
                    id="notes"
