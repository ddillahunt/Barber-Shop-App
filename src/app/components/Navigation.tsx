...
<button onClick={() => scrollToSection('team')} className="font-medium text-base text-sky-300 hover:text-sky-100 transition-colors flex items-center gap-1.5 whitespace-nowrap">
            ...
            <button onClick={() => { navigate("/about"); window.scrollTo(0, 0); }} className="font-medium text-base text-sky-300 hover:text-sky-100 transition-colors flex items-center gap-1.5 whitespace-nowrap">
