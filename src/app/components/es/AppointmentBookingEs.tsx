...
const services = [
  { name: "Recorte de Barba y Alineado", price: "$200" },
  { name: "Corte de Niños (11 Años y Menores)", price: "$35" },
  { name: "Corte Clásico", price: "$45" },
          ...
          <div className="bg-gradient-to-r from-red-700 via-red-600 to-red-600 p-8">
            <CardHeader className="p-0">
              <div className="flex items-center gap-4 text-white">
                ...
                <div>
                  <CardTitle className="text-white text-3xl mb-2 font-bold">Programa Tu Visita</CardTitle>
                  <CardDescription className="text-white/80 text-base font-medium">Elige tu barbero, servicio y hora preferida</CardDescription>
                </div>
              </div>
            </CardHeader>
          </div>
