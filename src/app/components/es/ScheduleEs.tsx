        ...
        <Card className="max-w-2xl mx-auto border-2 border-amber-500/30 shadow-2xl shadow-amber-500/20 overflow-hidden bg-slate-900">
          ...
          <CardContent className="p-0 bg-gradient-to-br from-slate-900 to-black">
            <div className="grid grid-cols-3 px-8 py-4" style={{ backgroundColor: "rgba(245, 158, 11, 0.2)", borderBottom: "2px solid rgba(245, 158, 11, 0.5)" }}>
              <span style={{ color: "#fbbf24", fontSize: "1.25rem", fontWeight: 700 }}>Día</span>
              <span style={{ color: "#fbbf24", fontSize: "1.25rem", fontWeight: 700, textAlign: "center" }}>Estado</span>
              <span style={{ color: "#fbbf24", fontSize: "1.25rem", fontWeight: 700, textAlign: "right" }}>Horario</span>
            </div>
