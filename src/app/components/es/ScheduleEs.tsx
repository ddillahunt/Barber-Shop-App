    ...
    <section id="schedule" className="py-20 bg-gradient-to-br from-slate-900 via-black to-slate-900">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-5xl mb-4 font-bold bg-gradient-to-r from-sky-300 via-blue-400 to-sky-300 bg-clip-text text-transparent">Horario de Atención</h2>
          <p className="text-sky-200 text-lg">Estamos aquí cuando nos necesitas</p>
        ...
        <Card className="max-w-2xl mx-auto border-2 border-blue-500/30 shadow-2xl shadow-blue-500/20 overflow-hidden bg-slate-900">
          <div className="bg-gradient-to-r from-red-700 via-red-600 to-red-700 p-6">
            <CardHeader className="p-0">
              <div className="flex items-center gap-3 text-white">
                ...
                <CardTitle className="text-white text-2xl font-bold">Nuestro Horario</CardTitle>
              </div>
            </CardHeader>
          </div>
          <CardContent className="p-0 bg-gradient-to-br from-slate-900 to-black">
            <div className="grid grid-cols-3 px-8 py-4" style={{ backgroundColor: "rgba(43, 108, 176, 0.2)", borderBottom: "2px solid rgba(43, 108, 176, 0.5)" }}>
              <span style={{ color: "#7CB9E8", fontSize: "1.25rem", fontWeight: 700 }}>Día</span>
              <span style={{ color: "#7CB9E8", fontSize: "1.25rem", fontWeight: 700, textAlign: "center" }}>Estado</span>
              <span style={{ color: "#7CB9E8", fontSize: "1.25rem", fontWeight: 700, textAlign: "right" }}>Horario</span>
            </div>
